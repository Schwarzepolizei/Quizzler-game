...
class QuizzInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas_text = self.canvas.create_text(150, 125, width=280, text="xxx", fill="black", font=FONT_TEXT)
        self.canvas.grid(column=0, row=1, columnspan=2, pady=50)
        
        self.score_label = Label(fg="white", bg=THEME_COLOR, text=f"Score: 0", font=("Arial", 12, "bold"))
